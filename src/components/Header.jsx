...
const Header = () => {
  ...
  return (
    ...
    <div className="shadow-sm shadow-gray-600">
     ...
     <header className="w-full  flex justify-between items-center px-4 md:px-10 bgHeader text-white pb-1 relative">
        <div
        ...
        <div className="flex gap-2 justify-end items-end">
          <div className="flex flex-col -space-y-3 leading-none">
            ...
            <div className='flex flex-col -space-y-5 leading-none'>
              ...
              <span className="text-md text-center max-w-full  ">
          ...
          <div className="flex flex-col items-center leading-none tracking-tighter  -space-y-3">
            <p className="text-8xl text-blue-300 font-bold ">80</p>
        ...
        <span className="text-base md:text-md absolute text-end bottom-0 right-2">
            AÑO: LXXXI | Edición N° 20872
          </span>
      </header>
